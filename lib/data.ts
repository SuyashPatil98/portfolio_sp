...
export const projects: Project[] = [
  ...
  },
  {
    ...
    kind: "Open Project",
    description:
      "A multi-agent RAG pipeline (Planner / Retriever / Writer / Critic) with a vector store backend for long-form, citation-grounded writing. Optimized for both factuality and token cost.",
    architecture: [
      "Planner → Retriever → Writer → Critic agent loop",
      "Hybrid retrieval: dense embeddings + sparse BM25",
      "Vector store backend with query-result caching",
      "Parallelized retrieval execution across agents",
      "Agent-level validation loops gate the final draft",
    ],
    metrics: [
      { value: "35–50%", label: "Inference cost cut" },
      { value: "30–40%", label: "Factuality gain" },
    ],
    stack: [
      "Python",
      "LLMs",
